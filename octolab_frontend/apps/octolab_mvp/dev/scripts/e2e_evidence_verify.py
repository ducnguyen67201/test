...
class EvidenceVerifier:
    ...
    def _generate_traffic(self) -> None:
        ...
        # Try to curl target-web from OctoBox
        self._log("Generating traffic: curl target-web from OctoBox...")
        self._run_docker([
        ...
        # Also try ping
        self._log("Generating traffic: ping target-web...")
        self._run_docker([
            "exec", octobox_container,
            "ping", "-c", "3", "-W", "1", "target-web"
        ])
